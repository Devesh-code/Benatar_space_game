...
WIN = pygame.display.set_mode((WIDTH, HEIGHT),pygame.RESIZABLE) #  resizable window
...
YELLOW_LASER = pygame.image.load(os.path.join("assets", "laser-hazard.png"))

# Background
BG = pygame.transform.scale(pygame.image.load(os.path.join("assets", "bak01.jpg")), (WIDTH, HEIGHT))
...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.SysFont("Hack", 50)
    lost_font = pygame.font.SysFont("Hack", 60)
...
def main_menu():
    title_font = pygame.font.SysFont("Hack", 60)
    run = True
    while run:
        WIN.blit(BG, (0,0))
